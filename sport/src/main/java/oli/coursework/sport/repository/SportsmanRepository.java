...
public interface SportsmanRepository extends JpaRepository<Sportsman, Long> {
    ...
    Long countBySportClub_SportClubId(Long SportClubId);

    List<Sportsman> findByCompetitions_StartDateLessThanEqualOrCompetitions_StartDateGreaterThanEqualOrCompetitionsIsNull(Date firstDate, Date secondDate);
}
